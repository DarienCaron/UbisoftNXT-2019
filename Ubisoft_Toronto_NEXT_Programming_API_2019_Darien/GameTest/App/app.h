...
namespace App
{
    ...
    void DrawLine(Vector2 sx, Vector2 ex, Vector3 color);
    void DrawQuad(float sx, float sy, float ex, float ey, float r, float g, float b);
    void DrawQuad(Vector2Int sx, Vector2Int ex, Vector3 color);
    void DrawQuad(Vector2 sx, Vector2 ex, Vector3 color);
